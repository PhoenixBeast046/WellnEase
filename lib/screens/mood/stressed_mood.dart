// lib/screens/mood/stressed_mood.dart
...
class StressedMoodPage extends StatefulWidget {
  static const routeName = '/mood/stressed';
  const StressedMoodPage({Key? key}) : super(key: key);

  @override
  State<StressedMoodPage> createState() => _StressedMoodPageState();
}

class _StressedMoodPageState extends State<StressedMoodPage> {
  ...
  static const Color darkColor = Color(0xFFCE93D8);
  ...
  void didChangeDependencies() {
    ...
    if (!_moodRecorded) {
      _moodRecorded = true;
      context.read<DataService>().setLastMood('stressed');
    }
  }
            ...
            child: Column(
              children: [
                ...
                const Padding(
                  ...
                  child: Text(
                    'Your mind is working overtime—give it a break! ☕\nTake a deep breath, relax, and do what makes you happy.',
